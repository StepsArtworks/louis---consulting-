      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        >
          <div className="relative inline-block mb-8">
            ...
            <a
              ...
              className="absolute -bottom-2 -right-2 bg-green-500 rounded-full p-3 shadow-lg hover:bg-green-600 transition-all transform hover:scale-110 active:scale-95 cursor-pointer"
          ...
          <div
            className="inline-flex items-center gap-3 bg-white px-6 py-3 rounded-full shadow-md mb-8 hover:shadow-xl transition-shadow duration-300 cursor-default"
            style={{ animation: 'pulse-scale 2s ease-in-out infinite' }}
            onMouseEnter={(e) => e.currentTarget.style.animation = 'none'}
            onMouseLeave={(e) => e.currentTarget.style.animation = 'pulse-scale 2s ease-in-out infinite'}
          >
            <Clock className="w-5 h-5 text-blue-600" />
            <span className="font-semibold text-gray-900">1-Hour Expert Consultation</span>
            <span className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-teal-600">R500</span>
          </div>
        </div>
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600">Online English Teacher & Online Business Builder</p>
          </div>
